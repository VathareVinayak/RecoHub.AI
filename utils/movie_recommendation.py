...
# # Define file paths
# movie_dict_file = os.getenv("MOVIE_REC_MODEL_URL")  # Movie dictionary file
# similarity_model_file = os.getenv("MOVIE_RECOMMENDATION_MODEL_URL")  # Local similarity model
